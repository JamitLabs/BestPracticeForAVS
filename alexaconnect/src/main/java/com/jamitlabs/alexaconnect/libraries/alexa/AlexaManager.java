...
import com.jamitlabs.alexaconnect.libraries.alexa.interfaces.AvsException;
...
import com.jamitlabs.alexaconnect.libraries.alexa.interfaces.GenericSendEvent;
...
import com.jamitlabs.alexaconnect.libraries.alexa.interfaces.speechrecognizer.SpeechSendAudio;
import com.jamitlabs.alexaconnect.libraries.alexa.interfaces.speechrecognizer.SpeechSendText;
import com.jamitlabs.alexaconnect.libraries.alexa.interfaces.speechrecognizer.SpeechSendVoice;
...
import com.jamitlabs.alexaconnect.libraries.alexa.service.DownChannelService;
...
import static com.jamitlabs.alexaconnect.libraries.alexa.utility.Util.IDENTIFIER;
...
public class AlexaManager {
     ...
     * See: {@link #sendEvent(String, AsyncCallback)}
     *
     * @param volume volume as reported by the {@link com.jamitlabs.alexaconnect.libraries.alexa.interfaces.speaker.AvsAdjustVolumeItem} Directive
     ...
     * See: {@link #sendEvent(String, AsyncCallback)}
     *
     * @param isMute mute state as reported by the {@link com.jamitlabs.alexaconnect.libraries.alexa.interfaces.speaker.AvsSetMuteItem} Directive
     * @param callback
     */
    ...
    /**
     * Send a generic event to the AVS server, this is generated using {@link com.jamitlabs.alexaconnect.libraries.alexa.data.Event.Builder}
