package com.jamitlabs.alexavoiceserviceandroid.libraries.alexa;
...
import com.jamitlabs.alexavoiceserviceandroid.libraries.alexa.callbacks.AuthorizationCallback;
import com.jamitlabs.alexavoiceserviceandroid.libraries.alexa.data.Event;
...
import com.jamitlabs.alexavoiceserviceandroid.libraries.alexa.interfaces.GenericSendEvent;
import com.jamitlabs.alexavoiceserviceandroid.libraries.alexa.interfaces.audioplayer.AvsPlayAudioItem;
import com.jamitlabs.alexavoiceserviceandroid.libraries.alexa.interfaces.response.ResponseParser;
import com.jamitlabs.alexavoiceserviceandroid.libraries.alexa.interfaces.speechrecognizer.SpeechSendAudio;
import com.jamitlabs.alexavoiceserviceandroid.libraries.alexa.interfaces.speechrecognizer.SpeechSendText;
import com.jamitlabs.alexavoiceserviceandroid.libraries.alexa.interfaces.speechrecognizer.SpeechSendVoice;
...
import com.jamitlabs.alexavoiceserviceandroid.libraries.alexa.service.DownChannelService;
import com.jamitlabs.alexavoiceserviceandroid.libraries.alexa.system.AndroidSystemHandler;
import com.jamitlabs.alexavoiceserviceandroid.libraries.alexa.utility.Util;
...
import static com.jamitlabs.alexavoiceserviceandroid.libraries.alexa.AuthorizationManager.createCodeVerifier;
import static com.jamitlabs.alexavoiceserviceandroid.libraries.alexa.interfaces.response.ResponseParser.getBoundary;
import static com.jamitlabs.alexavoiceserviceandroid.libraries.alexa.utility.Util.IDENTIFIER;
...
public class AlexaManager {
    ...
    /**
     * Send a synchronize state {@link Event} request to Alexa Servers to retrieve pending {@link Directive}
     ...
     * See: {@link #sendEvent(String, AsyncCallback)}
     *
     * @param volume volume as reported by the {@link com.jamitlabs.alexavoiceserviceandroid.libraries.alexa.interfaces.speaker.AvsAdjustVolumeItem} Directive
     ...
     * See: {@link #sendEvent(String, AsyncCallback)}
     *
     * @param isMute mute state as reported by the {@link com.jamitlabs.alexavoiceserviceandroid.libraries.alexa.interfaces.speaker.AvsSetMuteItem} Directive
     * @param callback
     */
    ...
    /**
     * Send a generic event to the AVS server, this is generated using {@link com.jamitlabs.alexavoiceserviceandroid.libraries.alexa.data.Event.Builder}
